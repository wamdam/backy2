...
# -*- coding: utf-8 -*-
#
# benji documentation build configuration file, created by
...
version = pkg_resources.get_distribution('benji').version.rsplit(".", 1)[0]
# The full version, including alpha/beta/rc tags.
release = pkg_resources.get_distribution('benji').version
